...
def change_vio_color(violin):
    ...
    violin['cmedians'].set_colors(["#455A64"])
...
plt.savefig("../6_Results/Analysis/pers_violin.pdf", format="pdf", dpi=300, bbox_inches="tight")
plt.close()
...
plt.bar(sorted_keys, sorted_values, edgecolor='#455A64', color='#2a9d8f', width=0.4)
plt.xlabel("Age Range")
plt.ylabel("No. of Users")
plt.savefig("../6_Results/Analysis/users_age.pdf", format="pdf", dpi=300, bbox_inches="tight")
plt.close()
...
## user histogram
plt.figure(dpi=300)
plt.bar(list(users_counts.keys()), list(users_counts.values()), edgecolor='#455A64', color='#2a9d8f',
        width = 0.4)
plt.xlabel("Users")
plt.ylabel("No. of Annotations")
#plt.show()
plt.savefig("../6_Results/Analysis/users_hist.pdf", format="pdf", dpi=300, bbox_inches="tight")
...
plt.figure(dpi=300)
plt.bar(list(genre_counts.keys()), list(genre_counts.values()), edgecolor='#455A64', color='#2a9d8f',
        width = 0.4)
...
#plt.show()
plt.savefig("../6_Results/Analysis/genre_hist_all_samples.pdf", format="pdf", dpi=300, bbox_inches="tight")
plt.close()
...
plt.figure(dpi=300)
plt.bar(list(ar_counts.keys()), list(ar_counts.values()), edgecolor='#455A64', color='#2a9d8f',
        width = 0.4)
plt.xlabel("Arousal")
plt.ylabel("No. of Annotations")
#plt.show()
plt.savefig("../6_Results/Analysis/ar_hist.pdf", format="pdf", dpi=300, bbox_inches="tight")
plt.close()


plt.figure(dpi=300)
plt.bar(list(vl_counts.keys()), list(vl_counts.values()), width = 0.4, edgecolor='#455A64', color='#2a9d8f')
plt.xlabel("Valence")
plt.ylabel("No. of Annotations")
#plt.show()
plt.savefig("../6_Results/Analysis/vl_hist.pdf", format="pdf", dpi=300, bbox_inches="tight")
plt.close("all")
...
#plt.show()
plt.savefig("../6_Results/Analysis/ar_violin_meanEDA.pdf", format="pdf", dpi=300, bbox_inches="tight")
plt.close()
...
plt.tight_layout()
#plt.show()
plt.savefig("../6_Results/Analysis/vl_violin_meanEDA.pdf", format="pdf", dpi=300, bbox_inches="tight")
plt.close()
...
#plt.show()
plt.savefig("../6_Results/Analysis/genre_violin_meanEDA.pdf", format="pdf", dpi=300, bbox_inches="tight")
plt.close()
...
#plt.show()
plt.savefig("../6_Results/Analysis/ar_violin_meanHR.pdf", format="pdf", dpi=300, bbox_inches="tight")
plt.close()
...
plt.ylabel(r'$\mu$ Norm. (p/ subj. sess.) HR')
#plt.show()
plt.savefig("../6_Results/Analysis/vl_violin_meanHR.pdf", format="pdf", dpi=300, bbox_inches="tight")
plt.close()
...
plt.xticks(x, labels=list(genre_counts.keys()), rotation = 45)
#plt.show()
plt.savefig("../6_Results/Analysis/genre_violin_meanHR.pdf", format="pdf", dpi=300, bbox_inches="tight")
plt.close()
...
plt.xticks(x, labels=list(genre_counts.keys()), rotation = 45)
#plt.show()
plt.savefig("../6_Results/Analysis/genre_violin_arousal.pdf", format="pdf", dpi=300, bbox_inches="tight")
plt.close()
...
plt.xticks(x, labels=list(genre_counts.keys()), rotation = 45)
#plt.show()
plt.savefig("../6_Results/Analysis/genre_violin_valence.pdf", format="pdf", dpi=300, bbox_inches="tight")
plt.close()
